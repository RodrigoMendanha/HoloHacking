...
test('o indice cobre as fontes do manifesto', () => {
  const r = indexar();
...
test('a busca cita fonte, secao e linha', () => {
...
test('a citacao nao repete o titulo da fonte no caminho de secoes', () => {
...
test('a busca acha conteudo que so existe no livro', () => {
...
test('busca devolve nada para pergunta fora do metodo', () => {
...
test('a cobertura minima descarta trecho que responde outra pergunta', () => {
...
test('a busca por sistema filtra os trechos', () => {
...
test('o gabarito de perguntas passa inteiro', () => {
